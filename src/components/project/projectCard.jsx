const projectCard = () =>  { return (<div key={project.id} className="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadowbg-flashWhite dark:bg-metalBlack dark:border-gray-700">
{/*<a href={project.link}>
  <Image
    width={500} 
    height={300}
